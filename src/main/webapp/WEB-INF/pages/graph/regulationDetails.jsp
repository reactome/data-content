        ...
        <c:if test="${not empty databaseObject.regulatedEntity}">
            <div class="fieldset-pair-container">
                ...
                <div class="favth-col-lg-10 favth-col-md-10 favth-col-sm-9 favth-col-xs-12 details-field">
                    ...
                    <a href="${detailRequestPrefix}${databaseObject.regulatedEntity.stId}" class="" title="Show Details"   <c:if test="${not empty widget}">target="_blank"</c:if>>${databaseObject.regulatedEntity.displayName}</a>
                </div>
            </div>
        </c:if>
        <c:if test="${not empty databaseObject.regulator}">
            <div class="fieldset-pair-container">
                ...
                <div class="favth-col-lg-10 favth-col-md-10 favth-col-sm-9 favth-col-xs-12 details-field">
                    ...
                    <a href="${detailRequestPrefix}${databaseObject.regulator.stId}" class="" title="Show Details"   <c:if test="${not empty widget}">target="_blank"</c:if> >${databaseObject.regulator.displayName}</a>
                </div>
            </div>
        </c:if>
    </fieldset>

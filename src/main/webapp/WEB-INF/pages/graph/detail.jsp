...
<c:import url="../header.jsp"/>
    <div class="favth-col-xs-12">
        ...
        <c:if test="${not empty previewURL || not empty databaseObject}">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="biopax-dropdown">
                                            ...
                                            <div class="biopax-version-tooltip">
                                                <a href="/ReactomeRESTfulAPI/RESTfulWS/biopaxExporter/Level2/${databaseObject.dbId}"
                                                   download="${databaseObject.stId}_level2.owl">Level 2</a>
                                                <a href="/ReactomeRESTfulAPI/RESTfulWS/biopaxExporter/Level3/${databaseObject.dbId}"
                                                   download="${databaseObject.stId}_level3.owl">Level 3</a>
                                            </div>
                                        </div>

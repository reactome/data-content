                            ...
                            <%--<div class="favth-col-lg-12 favth-col-md-12 favth-col-sm-12 favth-col-xs-12 padding0">--%>
                                <%--<div class="">--%>
                                    ...
                                    <%--<div class="biopax-dropdown">--%>
                                        ...
                                        <%--</div>--%>
                                    <%--</div>--%>
                                    <%--&lt;%&ndash; UNCOMMENT TO EXPORT TO PDF &ndash;%&gt;--%>
                                    <%--&lt;%&ndash;&nbsp;|&nbsp;<a href="/ContentService/exporter/diagram/${databaseObject.stId}.pdf" download="${databaseObject.stId}.pdf" title="Export diagram to PDF">PDF</a>&ndash;%&gt;--%>
                                <%--</div>--%>
                            <%--</div>--%>
                        <%--</div>--%>
